    ...
    <div class="flex sm:px-18 px-4">
      <div class="w-full flex justify-between items-center">
        ...
        <div class="flex items-center space-x-7">
          ...
          <nuxt-link v-if="loggedInUser.roles.includes('Sales') || loggedInUser.roles.includes('Sales Section Head') || loggedInUser.roles.includes('Sales Operation') || loggedInUser.roles.includes('Admin') || loggedInUser.roles.includes('Director') || loggedInUser.roles.includes('Product') || loggedInUser.roles.includes('Coverplus')" to="/request"
                     exact-active-class="nav-link-active"
