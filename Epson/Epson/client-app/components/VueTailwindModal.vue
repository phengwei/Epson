<template>
  ...
  >
    <div v-show="showing" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex items-end justify-center min-h-screen pt-4 pl-0 px-2 sm:pl-4 sm:px-4 pb-20 text-center">
        ...
        <div class="m-8 inline-block align-middle w-full overflow-hidden max-w-6xl bg-white rounded-2xl shadow-xl transform transition-all">
          <slot></slot>
        </div>
      </div>
    </div>
