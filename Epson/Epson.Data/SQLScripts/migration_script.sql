...
ALTER TABLE Request DROP COLUMN ManagerId;
ALTER TABLE Request DROP COLUMN ManagerName;
ALTER TABLE Request DROP COLUMN Quantity;

ALTER TABLE RequestProduct ADD COLUMN FulfillerId VARCHAR(255);
ALTER TABLE RequestProduct ADD COLUMN HasFulfilled TINYINT(1) NOT NULL DEFAULT 0;
ALTER TABLE RequestProduct ADD COLUMN Price DECIMAL(20, 6) NOT NULL DEFAULT 0;

ALTER TABLE Request ADD COLUMN TotalBudget DECIMAL(20, 6) NOT NULL DEFAULT 0;
ALTER TABLE Request ADD COLUMN ApprovalState INT(10);